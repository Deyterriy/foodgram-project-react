# Generated by Django 3.2.16 on 2023-11-08 17:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='recipes/', verbose_name='Название рецепта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#FFFFFF', help_text='Введите цвет тега, например #FFFFFF', max_length=7, unique=True, validators=[django.core.validators.RegexValidator(message='Некорректное значение цвета', regex='^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$')], verbose_name='Цвет')),
